...
BTC_ORACLE_BINANCE_WS_URL=wss://fstream.binance.com/ws/btcusdt@aggTrade
BTC_ORACLE_BINANCE_RET1_MIN_BPS=0
BTC_ORACLE_BINANCE_MAX_AGE_MS=1500
...
ensure_env STRATEGY btc_oracle_fallback
...
ensure_env BTC_ORACLE_BINANCE_MOMENTUM 0
ensure_env BTC_ORACLE_BINANCE_WS_URL wss://fstream.binance.com/ws/btcusdt@aggTrade
ensure_env BTC_ORACLE_BINANCE_RET1_MIN_BPS 0
ensure_env BTC_ORACLE_BINANCE_MAX_AGE_MS 1500
...
ensure_env BTC_LADDER_MID_BUDGET_FRAC 1.0
...
ensure_env BTC_LADDER_TAIL_MAX_ASK 0.01
...
[Unit]
Description=mybot-codex BTC oracle fallback dry-run bot
